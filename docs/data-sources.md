...
| `planning/CIP_Codes.pdf` | Vanderbilt Registrar's official CIP code list ("Reviewed August 2025") | (not tracked in git — university-internal PDF) | 2026-08-01 | Used to assign/verify `cip2020_code` for 13 of Vanderbilt's 15 online Master's/Doctorate programs; found and provided by Pranish directly, not scraped. See `decisions-log.md` for the full mapping and match-rate against the algorithmic shortlist. |
